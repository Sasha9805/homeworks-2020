...
$(document).ready(function() {
  ...
  $('.owl-carousel').owlCarousel({
    ...
    nav: true,
    dots: false,
    navText: ['<div class="arrows__left"><img src="img/portfolio/left-arrow.png" alt="left-arrow"></div>', '<div class="arrows__right"><img src="img/portfolio/right-arrow.png" alt="right-arrow"></div>'],
    // navText: [$('.arrows__right'), $('.arrows__right')]
    responsive: {
      0: {
        items: 1
      },
